...
async def schedule_job(
    ...
    Args:
        ...
        trigger_at: ISO 8601 datetime string for when the job should trigger, preferably with timezone offset (e.g., '2025-10-27T15:00:00+05:30'). If no timezone is provided, the configured user timezone is assumed.
    ...
    try:
        ...
        try:
            ...
            # Make naive datetimes timezone-aware using the configured user timezone
